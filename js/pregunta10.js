Swal.fire({
    title:'<span class="white">Decima Pregunta</span>',
    text:'¿Coincide for?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "A Purpose" || pregunta1.value === "A purpose" || pregunta1.value === "a purpose" || pregunta1.value === "a Purpose"){
    Swal.fire({
        ...
        window.location.href = "ingresacontraseña.html";
    })
    ;
