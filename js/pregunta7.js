Swal.fire({
    title:'<span class="white">Septima Pregunta</span>',
    text:'¿Cuando compartimos fondo de pantalla de celular por primera vez o de que fue?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "04/junio/2020" || pregunta1.value === "04/Junio/2020" || pregunta1.value === "rakan y xayah" || pregunta1.value === "Rakan y Xayah"){
    Swal.fire({
