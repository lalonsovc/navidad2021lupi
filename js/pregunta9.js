Swal.fire({
    title:'<span class="white">Novena Pregunta</span>',
    text:'¿Cual fue la primera pelicula que vimos juntos?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "Fantasy Island" || pregunta1.value === "fantasy island" || pregunta1.value === "isla fantasia" || pregunta1.value === "Isla Fantasia"){
    Swal.fire({
