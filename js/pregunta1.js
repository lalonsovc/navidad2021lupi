Swal.fire({
    title:'<span class="white">Primera Pregunta</span>',
    text:'¿En que fecha fuimos novios por primera vez?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "21/mayo/2020" || pregunta1.value === "21/Mayo/2020"){
    Swal.fire({
