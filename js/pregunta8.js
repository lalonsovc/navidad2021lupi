Swal.fire({
    title:'<span class="white">Octava Pregunta</span>',
    text:'¿Cuando vimos nuestras caras por primera vez?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "01/junio/2020" || pregunta1.value === "01/Junio/2020"){
    Swal.fire({
