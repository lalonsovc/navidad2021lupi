Swal.fire({
    title:'<span class="white">Segunda Pregunta</span>',
    text:'¿Que queria ser Ranita de niño cuando sea grande?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "veterinario" || pregunta1.value === "Veterinario"){
    Swal.fire({
